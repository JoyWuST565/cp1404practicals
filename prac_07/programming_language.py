...
class ProgrammingLanguage:
    ...
    def __init__(self, name, typing, reflection, year, pointer_arithmetic):
        ...
        :param pointer_arithmetic: bool, supports pointer arithmetic
        """
        self.name = name
        self.typing = typing
    ...
    def __repr__(self):
        """
        Return string representation of a ProgrammingLanguage instance.

        :return: str, formatted information about the language
        """
    ...
    def is_dynamic(self):
        ...
        :return: bool, True if typing is Dynamic
        """
